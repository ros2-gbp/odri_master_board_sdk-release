...
%global pkg_name odri_master_board_sdk
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-odri-master-board-sdk
Version:        1.0.7
Release:        4%{?dist}
...
%changelog
* Wed Apr 29 2026 Maximilien Naveau <mnaveau@tue.mpg.de> - 1.0.7-4
- Autogenerated by Bloom

* Tue Apr 28 2026 Maximilien Naveau <mnaveau@tue.mpg.de> - 1.0.7-3
- Autogenerated by Bloom

* Tue Apr 21 2026 Maximilien Naveau <mnaveau@tue.mpg.de> - 1.0.7-2
- Autogenerated by Bloom
